...
@:pythonImport("websockets.legacy.client", "WebSocketClientProtocol") extern class WebSocketClientProtocol {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?logger:Dynamic, ?origin:Dynamic, ?extensions:Dynamic, ?subprotocols:Dynamic, ?extra_headers:Dynamic, ?user_agent_header:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?logger:Dynamic, ?origin:Dynamic, ?extensions:Dynamic, ?subprotocols:Dynamic, ?extra_headers:Dynamic, ?user_agent_header:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function handshake(wsuri:Dynamic, ?origin:Dynamic, ?available_extensions:Dynamic, ?available_subprotocols:Dynamic, ?extra_headers:Dynamic):Dynamic;
	...
	**/
	static public function process_subprotocol(headers:Dynamic, available_subprotocols:Dynamic):Dynamic;
	/**
	...
	**/
	public function read_http_response():Dynamic;
	/**
	...
	**/
	public function write_http_request(path:Dynamic, headers:Dynamic):Dynamic;
}