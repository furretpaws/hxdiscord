...
@:pythonImport("websockets.legacy.auth", "BasicAuthWebSocketServerProtocol") extern class BasicAuthWebSocketServerProtocol {
	/**
	...
	**/
	@:native("__init__")
	public function ___init__(?args:python.VarArgs<Dynamic>, ?realm:Dynamic, ?check_credentials:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(?args:python.VarArgs<Dynamic>, ?realm:Dynamic, ?check_credentials:Dynamic, ?kwargs:python.KwArgs<Dynamic>):Void;
	/**
	...
	**/
	public function check_credentials(username:Dynamic, password:Dynamic):Dynamic;
	/**
	...
	**/
	...
	static public var realm : Dynamic;
	/**
	...
	**/
	...
	static public var username : Dynamic;
	/**
