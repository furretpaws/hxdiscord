...
@:pythonImport("websockets.connection") extern class Connection_Module {
	static public var CLIENT : Dynamic;
	static public var CLOSED : Dynamic;
	static public var CLOSING : Dynamic;
	static public var CONNECTING : Dynamic;
	static public function Event(?args:python.VarArgs<Dynamic>, ?kwargs:python.KwArgs<Dynamic>):Dynamic;
	/**
	...
	**/
	...
	static public var SEND_EOF : Dynamic;
