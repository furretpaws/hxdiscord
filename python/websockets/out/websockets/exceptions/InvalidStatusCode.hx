...
@:pythonImport("websockets.exceptions", "InvalidStatusCode") extern class InvalidStatusCode {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(status_code:Dynamic, headers:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(status_code:Dynamic, headers:Dynamic):Void;
	/**
