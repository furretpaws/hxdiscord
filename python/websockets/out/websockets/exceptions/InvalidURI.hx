...
@:pythonImport("websockets.exceptions", "InvalidURI") extern class InvalidURI {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(uri:Dynamic, msg:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(uri:Dynamic, msg:Dynamic):Void;
	/**
