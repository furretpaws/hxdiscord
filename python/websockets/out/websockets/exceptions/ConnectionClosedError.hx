...
@:pythonImport("websockets.exceptions", "ConnectionClosedError") extern class ConnectionClosedError {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(rcvd:Dynamic, sent:Dynamic, ?rcvd_then_sent:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(rcvd:Dynamic, sent:Dynamic, ?rcvd_then_sent:Dynamic):Void;
	/**
