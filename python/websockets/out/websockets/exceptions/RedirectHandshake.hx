...
@:pythonImport("websockets.exceptions", "RedirectHandshake") extern class RedirectHandshake {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(uri:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(uri:Dynamic):Void;
	/**
