...
@:pythonImport("websockets.exceptions", "InvalidOrigin") extern class InvalidOrigin {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(origin:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(origin:Dynamic):Void;
	/**
