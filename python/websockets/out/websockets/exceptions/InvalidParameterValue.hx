...
@:pythonImport("websockets.exceptions", "InvalidParameterValue") extern class InvalidParameterValue {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(name:Dynamic, value:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(name:Dynamic, value:Dynamic):Void;
	/**
