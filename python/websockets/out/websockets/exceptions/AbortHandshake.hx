...
@:pythonImport("websockets.exceptions", "AbortHandshake") extern class AbortHandshake {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(status:Dynamic, headers:Dynamic, ?body:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(status:Dynamic, headers:Dynamic, ?body:Dynamic):Void;
	/**
