...
@:pythonImport("websockets.exceptions", "InvalidStatus") extern class InvalidStatus {
	/**
		exception cause
	**/
	...
	**/
	@:native("__init__")
	public function ___init__(response:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(response:Dynamic):Void;
	/**
