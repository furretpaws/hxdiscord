...
@:pythonImport("websockets.http11", "Request") extern class Request {
	...
	**/
	@:native("__init__")
	public function ___init__(path:Dynamic, headers:Dynamic, ?_exception:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(path:Dynamic, headers:Dynamic, ?_exception:Dynamic):Void;
	/**
	...
	**/
	static public function parse(read_line:Dynamic):Dynamic;
	/**
