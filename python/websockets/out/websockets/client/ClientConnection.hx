...
@:pythonImport("websockets.client", "ClientConnection") extern class ClientConnection {
	...
	**/
	@:native("__init__")
	public function ___init__(wsuri:Dynamic, ?origin:Dynamic, ?extensions:Dynamic, ?subprotocols:Dynamic, ?state:Dynamic, ?max_size:Dynamic, ?logger:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(wsuri:Dynamic, ?origin:Dynamic, ?extensions:Dynamic, ?subprotocols:Dynamic, ?state:Dynamic, ?max_size:Dynamic, ?logger:Dynamic):Void;
	/**
	...
	**/
	public function process_response(response:Dynamic):Dynamic;
	/**
	...
	**/
	public function send_request(request:Dynamic):Dynamic;
	/**
		Send a `Text frame`_.
