...
@:pythonImport("websockets.frames", "Close") extern class Close {
	...
	**/
	@:native("__init__")
	public function ___init__(code:Dynamic, reason:Dynamic):Dynamic;
	/**
		Initialize self.  See help(type(self)) for accurate signature.
	**/
	public function new(code:Dynamic, reason:Dynamic):Void;
	/**
